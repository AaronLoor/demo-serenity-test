...
Característica: Funcionalidad demo puntonet
  ...
  Esquema del escenario: Registro de cliente puntonet
    ...
    Ejemplos:
      ...
      | puntonet.user | password   | Aaron Wladimir    | Loor Moran       | 1316870698 | 18/06/1998       | 0991234567 | Union de Hecho | aaron.loor@puntonet.ec      | Masculino | Cdla. Santa Clara, Guayaquil     |
